...
def create_tables():
    ...
    # Create table for storing friend list data
    cursor.execute('''
    ...
    # Create table for storing user details and their steamid (username, teamid)
    cursor.execute('''
...
# Function to insert friend list data into the friends table
...
# Function to insert username and steamid into the users table
